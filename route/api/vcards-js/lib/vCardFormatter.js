...
(function vCardFormatter() {
	...
	module.exports = {
		...
		getFormattedString: function(vCard) {
			...
			if (vCard.instagramUrl) {
				formattedVCardString += 'URL;Type=instagram' + ':' + e(vCard.instagramUrl) + nl();
			}

			// if (vCard.venmoUrl) {
			// 	formattedVCardString += 'URL;Type=venmo' + ':' + e(vCard.venmoUrl) + nl();
			// }

			if (vCard.snapchatUrl) {
				formattedVCardString += 'URL;Type=snapchat' + ':' + e(vCard.snapchatUrl) + nl();
			}

			if (vCard.twitterUrl) {
				formattedVCardString += 'URL;Type=twitter' + ':' + e(vCard.twitterUrl) + nl();
			}

			if (vCard.facebookUrl) {
				formattedVCardString += 'URL;Type=facebook' + ':' + e(vCard.facebookUrl) + nl();
			}
			if (vCard.linkedinUrl) {
				formattedVCardString += 'URL;Type=linkedin' + ':' + e(vCard.linkedinUrl) + nl();
			}
			if (vCard.youtubeUrl) {
				formattedVCardString += 'URL;Type=youtube' + ':' + e(vCard.youtubeUrl) + nl();
			}
			if (vCard.applemusicUrl) {
				formattedVCardString += 'URL;Type=applemusic' + ':' + e(vCard.applemusicUrl) + nl();
			}
			if (vCard.spotifyUrl) {
				formattedVCardString += 'URL;Type=spotify' + ':' + e(vCard.spotifyUrl) + nl();
			}
			if (vCard.websiteUrl) {
				formattedVCardString += 'URL;Type=website' + ':' + e(vCard.websiteUrl) + nl();
			}
